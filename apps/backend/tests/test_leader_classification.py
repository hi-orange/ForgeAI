...
class LeaderClassificationTests(unittest.TestCase):
    ...
    def test_classifies_and_persists_message_without_starting_build(self) -> None:
        ...
        with patch.object(
            project_message_classification_service.leader_agent,
            "classify_message",
    ...
    def test_concurrent_insert_returns_the_winning_classification(self) -> None:
        ...
        with (
            patch.object(
                project_message_classification_service.project_service,
                "get_user_project",
                return_value=self.project,
            ),
            patch.object(
                project_message_classification_service,
            ...
            result = project_message_classification_service.classify_user_message(
                db,
                self.user,
                self.project.id,
                message.id,
